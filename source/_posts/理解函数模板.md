---
title: "理解函数模板"
date: 2025-03-06 15:42:54
updated: 2025-03-06 15:42:54
categories:
  - ["编程语言与算法", "C/C++"]
tags:
  - "C++模板编程"
description: "int 定死 函数模板让参数类型可变 1. 函数模板 不进行编译 2. 模板的实例化 在函数调用点编译 3. 模板函数 需要编译 4. 模板类型参数 5. 模板非类型参数 6. 模板的实参推演=>模板根据实参推导函数实例 7. 模板的..."
cover: ""
---
...
template<typename T,int SIZE>   //  这里size是常量，不可修改
